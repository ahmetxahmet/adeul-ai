...
(function() {
    ...
    window.openPromptBuilder = function() {
        ...
        _pbOverlay.innerHTML =
            ...
            '<button onclick="setPromptBuilderMode(\'exact\')" style="background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.7);font-weight:700;font-size:8px;letter-spacing:0.2em;text-transform:uppercase;padding:7px 10px;border-radius:8px;cursor:pointer;transition:all 0.2s;font-family:inherit;" onmouseenter="this.style.background=\'rgba(255,255,255,0.14)\';this.style.color=\'#fff\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.07)\';this.style.color=\'rgba(255,255,255,0.7)\'">📋 EXACT</button>' +
            '<button onclick="setPromptBuilderMode(\'interpret\')" style="background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.7);font-weight:700;font-size:8px;letter-spacing:0.2em;text-transform:uppercase;padding:7px 10px;border-radius:8px;cursor:pointer;transition:all 0.2s;font-family:inherit;" onmouseenter="this.style.background=\'rgba(255,255,255,0.14)\';this.style.color=\'#fff\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.07)\';this.style.color=\'rgba(255,255,255,0.7)\'">💡 INTERPRET</button>' +
            '<button onclick="setPromptBuilderMode(\'interior\')" style="background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.7);font-weight:700;font-size:8px;letter-spacing:0.2em;text-transform:uppercase;padding:7px 10px;border-radius:8px;cursor:pointer;transition:all 0.2s;font-family:inherit;" onmouseenter="this.style.background=\'rgba(255,255,255,0.14)\';this.style.color=\'#fff\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.07)\';this.style.color=\'rgba(255,255,255,0.7)\'">🏠 INTERIOR</button>' +
            '<button onclick="setPromptBuilderMode(\'exterior\')" style="background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.7);font-weight:700;font-size:8px;letter-spacing:0.2em;text-transform:uppercase;padding:7px 10px;border-radius:8px;cursor:pointer;transition:all 0.2s;font-family:inherit;" onmouseenter="this.style.background=\'rgba(255,255,255,0.14)\';this.style.color=\'#fff\'" onmouseleave="this.style.background=\'rgba(255,255,255,0.07)\';this.style.color=\'rgba(255,255,255,0.7)\'">🌳 EXTERIOR</button>' +
            '</div>' +
