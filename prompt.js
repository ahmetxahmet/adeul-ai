...
(function() {
    ...
    var promptLang = {
        ...
        'HI': { title: 'प्रॉम्प्ट बिल्डर', upload: 'छवि अपलोड करें', instruction: 'आप क्या चाहते हैं?', generate: 'प्रॉम्प्ट बनाएं', generating: 'विश्लेषण...', copyBtn: 'कॉपी', useBtn: 'रेंडर में उपयोग करें', close: 'बंद करें', placeholder: 'प्रॉम्प्ट यहां दिखाई देगा...', success: 'कॉपी किया!', noImage: 'कृपया पहले एक छवि अपलोड करें।', error: 'त्रुटि। पुनः प्रयास करें।', couponTitle: 'कूपन', couponPlaceholder: 'कूपन कोड', couponBtn: 'रिडीम', couponSuccess: 'कूपन लागू!', couponError: 'अमान्य कोड।' },
