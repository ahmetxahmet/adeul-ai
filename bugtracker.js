...
(function() {
    ...
    function createSocialButtons() {
        ...
        var instagram = '<a href="https://www.instagram.com/adeull.app/" target="_blank" style="color:rgba(255,255,255,0.4);transition:all 0.3s;display:block;" onmouseenter="this.style.color=\'#fff\';this.style.transform=\'scale(1.2)\'" onmouseleave="this.style.color=\'rgba(255,255,255,0.4)\';this.style.transform=\'scale(1)\'"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a>';
        var linkedin = '<a href="https://www.linkedin.com/in/adeull-adeull-4b9449401/" target="_blank" style="color:rgba(255,255,255,0.4);transition:all 0.3s;display:block;" onmouseenter="this.style.color=\'#fff\';this.style.transform=\'scale(1.2)\'" onmouseleave="this.style.color=\'rgba(255,255,255,0.4)\';this.style.transform=\'scale(1)\'"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></a>';
