...
(function() {
    ...
    var planFeatures = {
        'EN': {
            ...
            ultra:    ['350 credits / month', '350 × 1K renders OR 29 × 4K OR 11 × 8K', 'Welcome bonus: +40 1K renders', 'All design menus', 'Prompt Builder & Chat', 'Dedicated support', 'Network access (10 listings)'],
        },
        'TR': {
            ...
            ultra:    ['Ayda 350 kredi', '350 × 1K render VEYA 29 × 4K VEYA 11 × 8K', 'Hoş geldin bonusu: +40 1K render', 'Tüm tasarım menüleri', 'Prompt Builder ve Sohbet', 'Özel destek', 'Ağ erişimi (10 kayıt)'],
        },
        'ES': {
            ...
            ultra:    ['350 créditos / mes', '350 × 1K renders O 29 × 4K O 11 × 8K', 'Bono de bienvenida: +40 1K renders', 'Todos los menús de diseño', 'Prompt Builder y Chat', 'Soporte dedicado', 'Acceso a la Red (10 listados)'],
        },
        'DE': {
            ...
            ultra:    ['350 Credits / Monat', '350 × 1K Renders ODER 29 × 4K ODER 11 × 8K', 'Willkommensbonus: +40 1K Renders', 'Alle Design-Menüs', 'Prompt Builder und Chat', 'Dedizierter Support', 'Netzwerkzugang (10 Einträge)'],
        },
        'FR': {
            ...
            ultra:    ['350 crédits / mois', '350 × 1K rendus OU 29 × 4K OU 11 × 8K', 'Bonus de bienvenue: +40 1K rendus', 'Tous les menus de design', 'Prompt Builder et Chat', 'Support dédié', 'Accès au Réseau (10 fiches)'],
        },
        'PT': {
            ...
            ultra:    ['350 créditos / mês', '350 × 1K renders OU 29 × 4K OU 11 × 8K', 'Bônus de boas-vindas: +40 1K renders', 'Todos os menus de design', 'Prompt Builder e Chat', 'Suporte dedicado', 'Acesso à Rede (10 listagens)'],
        },
        'ID': {
            ...
            ultra:    ['350 kredit / bulan', '350 × 1K render ATAU 29 × 4K ATAU 11 × 8K', 'Bonus selamat datang: +40 1K render', 'Semua menu desain', 'Prompt Builder dan Chat', 'Dukungan khusus', 'Akses Jaringan (10 listing)'],
        },
        'RU': {
            ...
            ultra:    ['350 кредитов / месяц', '350 × 1K рендеров ИЛИ 29 × 4K ИЛИ 11 × 8K', 'Приветственный бонус: +40 1K рендеров', 'Все меню дизайна', 'Prompt Builder и Чат', 'Выделенная поддержка', 'Доступ к Сети (10 записей)'],
        },
        'AR': {
            ...
            ultra:    ['350 رصيد / شهر', '350 × 1K عرض أو 29 × 4K أو 11 × 8K', 'مكافأة ترحيب: +40 1K عروض', 'جميع قوائم التصميم', 'Prompt Builder والدردشة', 'دعم مخصص', 'الوصول إلى الشبكة (10 إدراجات)'],
        },
        'IT': {
            ...
            ultra:    ['350 crediti / mese', '350 × 1K render O 29 × 4K O 11 × 8K', 'Bonus di benvenuto: +40 1K render', 'Tutti i menu di design', 'Prompt Builder e Chat', 'Supporto dedicato', 'Accesso alla Rete (10 inserzioni)'],
        }
    };
