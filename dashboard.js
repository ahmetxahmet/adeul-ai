...
(function() {
    ...
    var planFeatures = {
        'EN': {
            student:  ['20 credits / month', '10 × 1K renders OR 1 × 4K render', 'Welcome bonus: +5 1K renders', 'All design menus', 'Prompt Builder & Chat', 'Email support'],
            standard: ['60 credits / month', '30 × 1K renders OR 5 × 4K', 'Welcome bonus: +10 1K renders', 'All design menus', 'Prompt Builder & Chat', 'Priority support', 'Network access (1 listing)'],
            pro:      ['150 credits / month', '75 × 1K renders OR 12 × 4K', 'Welcome bonus: +20 1K renders', 'All design menus', 'Prompt Builder & Chat', 'Priority support', 'Network access (4 listings)'],
            ultra:    ['350 credits / month', '175 × 1K renders OR 29 × 4K', 'Welcome bonus: +40 1K renders', 'All design menus', 'Prompt Builder & Chat', 'Dedicated support', 'Network access (10 listings)'],
        },
        'TR': {
            student:  ['Ayda 20 kredi', '10 × 1K render VEYA 1 × 4K render', 'Hoş geldin bonusu: +5 1K render', 'Tüm tasarım menüleri', 'Prompt Builder ve Sohbet', 'E-posta desteği'],
            standard: ['Ayda 60 kredi', '30 × 1K render VEYA 5 × 4K VEYA 2 × 8K', 'Hoş geldin bonusu: +10 1K render', 'Tüm tasarım menüleri', 'Prompt Builder ve Sohbet', 'Öncelikli destek', 'Ağ erişimi (1 kayıt)'],
            pro:      ['Ayda 150 kredi', '75 × 1K render VEYA 12 × 4K VEYA 5 × 8K', 'Hoş geldin bonusu: +20 1K render', 'Tüm tasarım menüleri', 'Prompt Builder ve Sohbet', 'Öncelikli destek', 'Ağ erişimi (4 kayıt)'],
            ultra:    ['Ayda 350 kredi', '175 × 1K render VEYA 29 × 4K VEYA 11 × 8K', 'Hoş geldin bonusu: +40 1K render', 'Tüm tasarım menüleri', 'Prompt Builder ve Sohbet', 'Özel destek', 'Ağ erişimi (10 kayıt)'],
        },
        'ES': {
            student:  ['20 créditos / mes', '10 × 1K renders O 1 × 4K render', 'Bono de bienvenida: +5 1K renders', 'Todos los menús de diseño', 'Prompt Builder y Chat', 'Soporte por email'],
            standard: ['60 créditos / mes', '30 × 1K renders O 5 × 4K O 2 × 8K', 'Bono de bienvenida: +10 1K renders', 'Todos los menús de diseño', 'Prompt Builder y Chat', 'Soporte prioritario', 'Acceso a la Red (1 listado)'],
            pro:      ['150 créditos / mes', '75 × 1K renders O 12 × 4K O 5 × 8K', 'Bono de bienvenida: +20 1K renders', 'Todos los menús de diseño', 'Prompt Builder y Chat', 'Soporte prioritario', 'Acceso a la Red (4 listados)'],
            ultra:    ['350 créditos / mes', '175 × 1K renders O 29 × 4K O 11 × 8K', 'Bono de bienvenida: +40 1K renders', 'Todos los menús de diseño', 'Prompt Builder y Chat', 'Soporte dedicado', 'Acceso a la Red (10 listados)'],
        },
        'DE': {
            student:  ['20 Credits / Monat', '10 × 1K Renders ODER 1 × 4K Render', 'Willkommensbonus: +5 1K Renders', 'Alle Design-Menüs', 'Prompt Builder und Chat', 'E-Mail-Support'],
            standard: ['60 Credits / Monat', '30 × 1K Renders ODER 5 × 4K ODER 2 × 8K', 'Willkommensbonus: +10 1K Renders', 'Alle Design-Menüs', 'Prompt Builder und Chat', 'Prioritätssupport', 'Netzwerkzugang (1 Eintrag)'],
            pro:      ['150 Credits / Monat', '75 × 1K Renders ODER 12 × 4K ODER 5 × 8K', 'Willkommensbonus: +20 1K Renders', 'Alle Design-Menüs', 'Prompt Builder und Chat', 'Prioritätssupport', 'Netzwerkzugang (4 Einträge)'],
            ultra:    ['350 Credits / Monat', '175 × 1K Renders ODER 29 × 4K ODER 11 × 8K', 'Willkommensbonus: +40 1K Renders', 'Alle Design-Menüs', 'Prompt Builder und Chat', 'Dedizierter Support', 'Netzwerkzugang (10 Einträge)'],
        },
        'FR': {
            student:  ['20 crédits / mois', '10 × 1K rendus OU 1 × 4K rendu', 'Bonus de bienvenue: +5 1K rendus', 'Tous les menus de design', 'Prompt Builder et Chat', 'Support email'],
            standard: ['60 crédits / mois', '30 × 1K rendus OU 5 × 4K OU 2 × 8K', 'Bonus de bienvenue: +10 1K rendus', 'Tous les menus de design', 'Prompt Builder et Chat', 'Support prioritaire', 'Accès au Réseau (1 fiche)'],
            pro:      ['150 crédits / mois', '75 × 1K rendus OU 12 × 4K OU 5 × 8K', 'Bonus de bienvenue: +20 1K rendus', 'Tous les menus de design', 'Prompt Builder et Chat', 'Support prioritaire', 'Accès au Réseau (4 fiches)'],
            ultra:    ['350 crédits / mois', '175 × 1K rendus OU 29 × 4K OU 11 × 8K', 'Bonus de bienvenue: +40 1K rendus', 'Tous les menus de design', 'Prompt Builder et Chat', 'Support dédié', 'Accès au Réseau (10 fiches)'],
        },
        'PT': {
            student:  ['20 créditos / mês', '10 × 1K renders OU 1 × 4K render', 'Bônus de boas-vindas: +5 1K renders', 'Todos os menus de design', 'Prompt Builder e Chat', 'Suporte por email'],
            standard: ['60 créditos / mês', '30 × 1K renders OU 5 × 4K OU 2 × 8K', 'Bônus de boas-vindas: +10 1K renders', 'Todos os menus de design', 'Prompt Builder e Chat', 'Suporte prioritário', 'Acesso à Rede (1 listagem)'],
            pro:      ['150 créditos / mês', '75 × 1K renders OU 12 × 4K OU 5 × 8K', 'Bônus de boas-vindas: +20 1K renders', 'Todos os menus de design', 'Prompt Builder e Chat', 'Suporte prioritário', 'Acesso à Rede (4 listagens)'],
            ultra:    ['350 créditos / mês', '175 × 1K renders OU 29 × 4K OU 11 × 8K', 'Bônus de boas-vindas: +40 1K renders', 'Todos os menus de design', 'Prompt Builder e Chat', 'Suporte dedicado', 'Acesso à Rede (10 listagens)'],
        },
        'ID': {
            student:  ['20 kredit / bulan', '10 × 1K render ATAU 1 × 4K render', 'Bonus selamat datang: +5 1K render', 'Semua menu desain', 'Prompt Builder dan Chat', 'Dukungan email'],
            standard: ['60 kredit / bulan', '30 × 1K render ATAU 5 × 4K ATAU 2 × 8K', 'Bonus selamat datang: +10 1K render', 'Semua menu desain', 'Prompt Builder dan Chat', 'Dukungan prioritas', 'Akses Jaringan (1 listing)'],
            pro:      ['150 kredit / bulan', '75 × 1K render ATAU 12 × 4K ATAU 5 × 8K', 'Bonus selamat datang: +20 1K render', 'Semua menu desain', 'Prompt Builder dan Chat', 'Dukungan prioritas', 'Akses Jaringan (4 listing)'],
            ultra:    ['350 kredit / bulan', '175 × 1K render ATAU 29 × 4K ATAU 11 × 8K', 'Bonus selamat datang: +40 1K render', 'Semua menu desain', 'Prompt Builder dan Chat', 'Dukungan khusus', 'Akses Jaringan (10 listing)'],
        },
        'RU': {
            student:  ['20 кредитов / месяц', '10 × 1K рендеров ИЛИ 1 × 4K рендер', 'Приветственный бонус: +5 1K рендеров', 'Все меню дизайна', 'Prompt Builder и Чат', 'Email поддержка'],
            standard: ['60 кредитов / месяц', '30 × 1K рендеров ИЛИ 5 × 4K ИЛИ 2 × 8K', 'Приветственный бонус: +10 1K рендеров', 'Все меню дизайна', 'Prompt Builder и Чат', 'Приоритетная поддержка', 'Доступ к Сети (1 запись)'],
            pro:      ['150 кредитов / месяц', '75 × 1K рендеров ИЛИ 12 × 4K ИЛИ 5 × 8K', 'Приветственный бонус: +20 1K рендеров', 'Все меню дизайна', 'Prompt Builder и Чат', 'Приоритетная поддержка', 'Доступ к Сети (4 записи)'],
            ultra:    ['350 кредитов / месяц', '175 × 1K рендеров ИЛИ 29 × 4K ИЛИ 11 × 8K', 'Приветственный бонус: +40 1K рендеров', 'Все меню дизайна', 'Prompt Builder и Чат', 'Выделенная поддержка', 'Доступ к Сети (10 записей)'],
        },
        'AR': {
            student:  ['20 رصيد / شهر', '10 × 1K عرض أو 1 × 4K عرض', 'مكافأة ترحيب: +5 1K عروض', 'جميع قوائم التصميم', 'Prompt Builder والدردشة', 'دعم البريد الإلكتروني'],
            standard: ['60 رصيد / شهر', '30 × 1K عرض أو 5 × 4K أو 2 × 8K', 'مكافأة ترحيب: +10 1K عروض', 'جميع قوائم التصميم', 'Prompt Builder والدردشة', 'دعم ذو أولوية', 'الوصول إلى الشبكة (إدراج واحد)'],
            pro:      ['150 رصيد / شهر', '75 × 1K عرض أو 12 × 4K أو 5 × 8K', 'مكافأة ترحيب: +20 1K عروض', 'جميع قوائم التصميم', 'Prompt Builder والدردشة', 'دعم ذو أولوية', 'الوصول إلى الشبكة (4 إدراجات)'],
            ultra:    ['350 رصيد / شهر', '175 × 1K عرض أو 29 × 4K أو 11 × 8K', 'مكافأة ترحيب: +40 1K عروض', 'جميع قوائم التصميم', 'Prompt Builder والدردشة', 'دعم مخصص', 'الوصول إلى الشبكة (10 إدراجات)'],
        },
        'IT': {
            student:  ['20 crediti / mese', '10 × 1K render O 1 × 4K render', 'Bonus di benvenuto: +5 1K render', 'Tutti i menu di design', 'Prompt Builder e Chat', 'Supporto email'],
            standard: ['60 crediti / mese', '30 × 1K render O 5 × 4K O 2 × 8K', 'Bonus di benvenuto: +10 1K render', 'Tutti i menu di design', 'Prompt Builder e Chat', 'Supporto prioritario', 'Accesso alla Rete (1 inserzione)'],
            pro:      ['150 crediti / mese', '75 × 1K render O 12 × 4K O 5 × 8K', 'Bonus di benvenuto: +20 1K render', 'Tutti i menu di design', 'Prompt Builder e Chat', 'Supporto prioritario', 'Accesso alla Rete (4 inserzioni)'],
            ultra:    ['350 crediti / mese', '175 × 1K render O 29 × 4K O 11 × 8K', 'Bonus di benvenuto: +40 1K render', 'Tutti i menu di design', 'Prompt Builder e Chat', 'Supporto dedicato', 'Accesso alla Rete (10 inserzioni)'],
        }
    };
